<template>
    <div class="Kursbackground">
        <h1 style="text-align: center; color: #333; margin: 20px 0; font-size: 24px;">Klass A - Kurslista</h1>
...
// Filtrera kurser för klass A
const filteredKurser = computed(() => {
    return kurserState.value.filter(kurs => kurs.class === "1A").map(kurs => {
